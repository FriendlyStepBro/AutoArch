...
# Use this to enable autologin and use hyprlock as the login manager. !!! WARNING This can make the system vulnerable to unknown threat vectors by curcumventing PAM.
